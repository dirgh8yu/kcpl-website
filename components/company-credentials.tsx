...
export function CompanyCredentials() {
  return <section className="section credentials-section" id="recognition"><Container>
    ...
    <div className="association-heading"><h3>Associations & industry network</h3><p className="small muted">KCPL’s stated associations. Organisation marks identify the respective bodies and do not imply endorsement.</p></div>
